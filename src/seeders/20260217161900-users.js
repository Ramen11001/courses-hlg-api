  ...
  async up(queryInterface, Sequelize) {
    ...
    const users = [
      //id 0
      {
        ...
        role: "USER",
        images: JSON.stringify(["https://randomuser.me/api/portraits/men/1.jpg"]),
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      //id 1
      {
        ...
        role: "USER",
        images: JSON.stringify(["https://randomuser.me/api/portraits/women/2.jpg"]),
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      //id 2
      ...
      // id 3
      {
        ...
        entity_type: "estatal",
        images: JSON.stringify(["https://randomuser.me/api/portraits/women/4.jpg"]),
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      //id 4
      ...
      //id 5
      {
        ...
        biography:
          "Me encanta enseñar y ver a mis alumnos crecer. Es mi vocación :)",
        entity_type: "privado",
        images: JSON.stringify(["https://randomuser.me/api/portraits/men/7.jpg"]),
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      //id 6
