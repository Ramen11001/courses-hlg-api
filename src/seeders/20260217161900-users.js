...
=======
    return queryInterface.bulkInsert(
      ...
      user[
        ...
        (this.email = user.map((UserEmails) => UserEmails.email)))
      ],
    );
  },

  async down(queryInterface, Sequelize) {
    return queryInterface.bulkDelete("Users", { email: this.email }, {});
>>>>>>> 18bd0a10e4f08e4a1a0481fba763ce366fdecd3c
  },
};
